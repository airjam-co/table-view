(function (global, factory) {
  ...
  var ViewComponentType,ViewType,PaginationStyle,TableViewStyle,DataSourceFieldType;!function(e){e.TableView="table_view";}(ViewComponentType||(ViewComponentType={})),function(e){e.Board="view_board",e.List="view_list",e.Feed="view_feed";}(ViewType||(ViewType={})),function(e){e.Paged="pagination_paged",e.InfiniteScroll="pagination_infinite",e.NoPagination="pagination_none";}(PaginationStyle||(PaginationStyle={})),function(e){e.List="table_view_list",e.Gallery="table_view_gallery",e.Graph="table_view_graph",e.Table="table_view_table";}(TableViewStyle||(TableViewStyle={})),function(e){e.Text="text",e.Number="number",e.DateTime="datetime",e.Currency="currency",e.Percent="percent",e.Link="link",e.Email="email";}(DataSourceFieldType||(DataSourceFieldType={}));
