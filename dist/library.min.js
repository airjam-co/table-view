(function (global, factory) {
  ...
  var ViewComponentType;!function(e){e.TableView="table_view";}(ViewComponentType||(ViewComponentType={}));var ViewType;!function(e){e.Board="view_board",e.List="view_list",e.Feed="view_feed";}(ViewType||(ViewType={}));var PaginationStyle;!function(e){e.Paged="pagination_paged",e.InfiniteScroll="pagination_infinite",e.NoPagination="pagination_none";}(PaginationStyle||(PaginationStyle={}));var TableViewStyle;!function(e){e.List="table_view_list",e.Gallery="table_view_gallery",e.Graph="table_view_graph",e.Table="table_view_table";}(TableViewStyle||(TableViewStyle={}));var DataSourceFieldType;!function(e){e.Text="text",e.Number="number",e.DateTime="datetime",e.Currency="currency",e.Percent="percent",e.Link="link",e.Email="email";}(DataSourceFieldType||(DataSourceFieldType={}));

  var template_cache={card_list:{shortId:"card_list",compatibleWith:"list",compatibleDisplayType:["list","gallery"],name:"Card List",owner_id:"",version:1,previewImageUrls:[],description:"card list.",visibility:"PUBLIC",pages:["LIST"],properties:{},templateContent:"<div class='container'><span class='title'>{{title}}</span><span class='image'><img src='{{thumbnail}}'/></span><span class='description'>{{description}}</span><span><a href='{{link}}'>{{linkText}}</a></span></div>",templateFields:{title:{name:"Title",description:"title",compatibleTypes:[]},link:{name:"Link",description:"Link to open",compatibleTypes:["link"]},linkText:{name:"Link Text",description:"Link text",compatibleTypes:[]},thumbnail:{name:"Thumbnail image",description:"thumbnail image",compatibleTypes:["link"]},description:{name:"Description",descriptions:"descriptions",compatibleTypes:[]}},componentProperties:{}},standard_table:{shortId:"standard_table",compatibleWith:"table_view",compatibleDisplayType:["table"],name:"Standard Table",owner_id:"",version:1,previewImageUrls:[],description:"table, as shown on the sheet itself.",visibility:"PUBLIC",pages:["LIST"],properties:{caption:{name:"Caption",description:"Use component's title as a caption",default:!1,type:"Boolean"},striped:{name:"Striped rows",description:"Do row colors alternate",default:!0,type:"Boolean"}},componentProperties:{}},barchart:{shortId:"barchart",compatibleWith:"table_view",compatibleDisplayType:["graph"],name:"Bar Chart",owner_id:"",version:1,previewImageUrls:[],description:"bar chart, rows must be horizontal and data in the second row to work.",visibility:"PUBLIC",pages:["LIST"],properties:{useFirstColumnAsLabels:{name:"First Column is Labels",description:"Use first column as labels",default:!0,type:"Boolean"},showLegends:{name:"Show Legends",description:"Show legends of labels in the graph",default:!0,type:"Boolean"},showVertically:{name:"ShowVertically",description:"Display graph vertically, rather than horizontally",default:!1,type:"Boolean"}},componentProperties:{chartType:"bar"}},piechart:{shortId:"piechart",compatibleWith:"table_view",compatibleDisplayType:["graph"],name:"Pie Chart",owner_id:"",version:1,previewImageUrls:[],description:"pie chart, rows must be horizontal and data in the second row to work.",visibility:"PUBLIC",pages:["LIST"],properties:{useFirstColumnAsLabels:{name:"First Column is Labels",description:"Use first column as labels",default:!0,type:"Boolean"},showLegends:{name:"Show Legends",description:"Show legends of labels in the graph",default:!0,type:"Boolean"},showVertically:{name:"ShowVertically",description:"Display graph vertically, rather than horizontally",default:!1,type:"Boolean"}},componentProperties:{chartType:"pie"}},linechart:{shortId:"linechart",compatibleWith:"table_view",compatibleDisplayType:["graph"],name:"Line Chart",owner_id:"",version:1,previewImageUrls:[],description:"line chart, rows must be horizontal and data in the second row to work.",visibility:"PUBLIC",pages:["LIST"],properties:{useFirstColumnAsLabels:{name:"First Column is Labels",description:"Use first column as labels",default:!0,type:"Boolean"},showLegends:{name:"Show Legends",description:"Show legends of labels in the graph",default:!0,type:"Boolean"},showVertically:{name:"ShowVertically",description:"Display graph vertically, rather than horizontally",default:!1,type:"Boolean"}},componentProperties:{chartType:"line"}}};var style_cache={muted:{shortId:"muted",name:"Muted",compatibleWith:["barchart"],owner_id:"",version:1,previewImageUrls:[],description:"single green color theme set",visibility:"PUBLIC",style:".muted>.table>tbody>tr:nth-child(odd)>td, .muted>.table>tbody>tr:nth-child(odd)>th { background-color: #F9F9FB; } .muted>.table th { font-size: smaller; color: #23262E; } .muted>.table>tbody>tr, .muted>.table>thead>tr { border: 0px solid transparent }",containerClassNames:["muted"],properties:{borderWidth:{name:"Border Width",description:"Border width",default:1,type:"Number"},chartColors:{name:"Chart Colors",description:"Chart colors",default:["#D79922","#EFE2BA","#F13C20","#4056A1","#C5CBE3"],type:"Color",multiple:!0,limit:50}},componentProperties:{borderWidth:1,chartColors:["#D79922","#EFE2BA","#F13C20","#4056A1","#C5CBE3"]}},earthy:{shortId:"earthy",name:"Earthy",compatibleWith:["barchart"],owner_id:"",version:1,previewImageUrls:[],description:"single green color theme set",visibility:"PUBLIC",style:".earthy>.table { border: 0.1em solid #E1E0E2; border-radius: 10px !important; border-collapse: separate; border-spacing: 0; overflow: hidden; } .earthy>.table thead { background-color: #F9FBFC; } .earthy>.table th { font-size: smaller; color: #828286; } .earthy>.table>tbody>tr, .earthy>.table>thead>tr { border-color: #F6F5F8 } .earthy>.table>tbody>tr:last-child { border: 0px solid transparent }",containerClassNames:["earthy"],properties:{borderWidth:{name:"Border Width",description:"Border width",default:1,type:"Number"},chartColors:{name:"Chart Colors",description:"Chart colors",default:["#E27D60","#85CDCA","#E8A87C","#C38D9E","#41B3A3"],type:"Color",multiple:!0,limit:50}},componentProperties:{borderWidth:1,chartColors:["#E27D60","#85CDCA","#E8A87C","#C38D9E","#41B3A3"]}},outback:{shortId:"outback",name:"Outback",compatibleWith:["barchart"],owner_id:"",version:1,previewImageUrls:[],description:"single green color theme set",visibility:"PUBLIC",style:".outback>.table th { font-size: smaller; color: #23262E; } .outback>.table>thead>tr { border: 0px solid transparent; border-top: 1px solid #EAE9EE; }",containerClassNames:["outback"],properties:{borderWidth:{name:"Border Width",description:"Border width",default:1,type:"Number"},chartColors:{name:"Chart Colors",description:"Chart colors",default:["#8D8741","#659DBD","#DAAD86","#BC986A","#FBEEC1","#C3C078","#9978C3","#82C378","#DE67A0"],type:"Color",multiple:!0,limit:50}},componentProperties:{borderWidth:1,chartColors:["#8D8741","#659DBD","#DAAD86","#BC986A","#FBEEC1","#C3C078","#9978C3","#82C378","#DE67A0"]}},concise_gallery:{shortId:"concise_gallery",name:"Concise gallery list",compatibleWith:["card_list"],owner_id:"",version:1,previewImageUrls:[],description:"Concision is the key.",visibility:"PUBLIC",style:".concise_gallery .container { display: inline-grid; padding: 10px; width: 300px; border: 1px solid #ddd; border-radius: 10px; margin: 5px; } .concise_gallery .container .title { font-size: 1.2 rem; font-weight: 600; }  .concise_gallery .container .image img { width: 100% } .concise_gallery .container .description { display: block } .concise_gallery .pagination a, .concise_gallery .pagination span { margin: 2px; padding: 3px; }",containerClassNames:["concise_gallery"],properties:{},componentProperties:{}}};

  var SERVING_DATA_URL="http://localhost:3001/s/data?id=",PAGINATION_SHOW_SIZE=7,currentPage={};function fetchAndRenderData(){window&&window.document&&document.querySelectorAll('[display="airjam-tableview"]').forEach((function(e){if(e.getAttribute("id")){var t=e.getAttribute("id");currentPage[t]=1,fetch(SERVING_DATA_URL+t+"&page=1").then((function(a){a.json().then((function(a){var r=getTemplate(a),n=getStyle(a);n.containerClassNames&&Array.isArray(n.containerClassNames)&&(e.className+=" "+n.containerClassNames.join(" "));var i=document.createElement("style");switch(i.appendChild(window.document.createTextNode(n.style)),window.document.head.appendChild(i),a.viewStyle){case TableViewStyle.Graph:renderGraphToView(t,e,a,r,n);break;case TableViewStyle.Table:renderTableToView(t,e,a);break;case TableViewStyle.List:case TableViewStyle.Gallery:renderCollectionToView(t,e,a,r);}}));}));}else e.innerHTML="Please set id attribute to a valid table view id.";}));}function fetchAndRerenderData(e,t,a){void 0===a&&(a=1),window&&window.document&&(currentPage[e]=a,fetch(SERVING_DATA_URL+e+"&page="+a).then((function(a){a.json().then((function(a){var r=getTemplate(a),n=getStyle(a);switch(t.innerHTML="",a.viewStyle){case TableViewStyle.Graph:renderGraphToView(e,t,a,r,n);break;case TableViewStyle.Table:renderTableToView(e,t,a);break;case TableViewStyle.List:case TableViewStyle.Gallery:renderCollectionToView(e,t,a,r);}}));})));}function renderCollectionToView(e,t,a,r,n){if(r.templateFields&&r.templateContent&&a.templateFields){for(var i=function(e){var n=a.data[e],i={};Object.keys(r.templateFields).forEach((function(e){a.templateFields[e]&&n[a.templateFields[e]]&&(i[e]=n[a.templateFields[e]].raw_value);}));var o=r.templateContent;Object.entries(i).forEach((function(e){var t=e[0],a=e[1];o=o.replaceAll("{{"+t+"}}",a);})),t.innerHTML+=o;},o=1;o<a.data.length;o++)i(o);a.paginationStyle===PaginationStyle.Paged&&renderPagination(e,t,a);}else console.log(e+" will not be rendered because it does not have required template attributes.");}function renderPagination(e,t,a){var r=window.document.createElement("div");r.className="pagination",t.appendChild(r);var n=currentPage[e]?currentPage[e]:1,i=currentPage[e]?currentPage[e]:1;if(a.totalPages<=PAGINATION_SHOW_SIZE)n=1,i=a.totalPages;else for(var o=PAGINATION_SHOW_SIZE;o>0;)n>1&&(n--,o--),i<=a.totalPages&&(i++,o--);r.appendChild(makePageLink(e,t,1,"<<"));for(var l=1;l<=a.totalPages;l++)r.appendChild(makePageLink(e,t,l,null));r.appendChild(makePageLink(e,t,a.totalPages,">>"));}function makePageLink(e,t,a,r){if(currentPage[e]===a){var n=window.document.createElement("span");return n.innerText=a.toString(),r&&(n.innerText=r),n}var i=window.document.createElement("a");return i.onclick=function(){fetchAndRerenderData(e,t,a);},i.innerText=a.toString(),r&&(i.innerText=r),i.style.cursor="pointer",i}function renderTableToView(e,t,a,r,n){var i="";a.templateProperties&&a.templateProperties.caption&&(i=a.templateProperties.caption);var o=!1;a.templateProperties&&a.templateProperties.striped&&(o="true"===a.templateProperties.striped.toLowerCase());var l=dataToTableMatrix(a);if(l&&l.length){var c=window.document.createElement("table");if(c.className="table table-hover",o&&(c.className+=" table-striped "),t.appendChild(c),i)window.document.createElement("caption").innerHTML=i;var d=window.document.createElement("thead"),s=window.document.createElement("tbody");c.appendChild(d),c.appendChild(s),l.forEach((function(e,t){var a=window.document.createElement("tr");a.className=evenOrOdd(t+1),0===t?d.appendChild(a):s.appendChild(a),e.forEach((function(e,r){var n=0===t?window.document.createElement("th"):window.document.createElement("td");n.appendChild(renderData(e)),n.className=evenOrOdd(r+1),a.appendChild(n);}));}));}}function renderData(e){var t=window.document.createElement("span");if(e.display_as===DataSourceFieldType.Link){var a=window.document.createElement("a");a.href=e.raw_value,a.innerText=e.raw_value,t.appendChild(a);}else t.innerText=e.raw_value;return t}function renderGraphToView(e,t,a,r,n){r.compatibleDisplayType&&Array.isArray(r.compatibleDisplayType)&&r.compatibleDisplayType.filter((function(e){return "graph"===e}))&&renderChartToView(e,t,a,r,n);}function renderChartToView(e,t,a,r,n){var i="bar";r.componentProperties&&r.componentProperties.chartType&&(i=r.componentProperties.chartType);var o=a.templateProperties&&a.templateProperties.useFirstColumnAsLabels&&a.templateProperties.useFirstColumnAsLabels,l=!0;a.templateProperties&&a.templateProperties.showLegends&&"false"===a.templateProperties.showLegends.toLowerCase()&&(l=!1);var c="x";a.templateProperties&&a.templateProperties.showVertically&&"true"===a.templateProperties.showVertically.toString().toLowerCase()&&(c="y");var d=0;n.componentProperties&&n.componentProperties.borderWidth&&(d=Number(n.componentProperties.borderWidth));var s=[];n.componentProperties&&n.componentProperties.chartColors&&Array.isArray(n.componentProperties.chartColors)&&(s=n.componentProperties.chartColors);var p=dataToTableMatrix(a);if(p&&p.length){for(var u=p[0].map((function(e){return e.raw_value})),m=[],h=1;h<p.length;h++){var w=p[h].map((function(e){return e.raw_value}));a.data.forEach((function(){s=rotateArray(s,!0);})),m.push({label:o?w[0]:void 0,data:o?w.slice(1):w,borderWidth:d,borderColor:s.slice(),backgroundColor:s.slice()});}var f=window.document.createElement("canvas");f.id=e,t.appendChild(f);new Chart(f,{type:i,data:{labels:o?u.slice(1):u,datasets:m},options:{indexAxis:c,plugins:{legend:{display:l}}}});}}function dataToTableMatrix(e){var t=[];if(e.data&&e.data.length){var a=Object.keys(e.data[0]),r={};a.forEach((function(e,t){r[e]=t;})),e.data.forEach((function(e){var a=[];Object.entries(e).forEach((function(e){a[r[e[0]]]=e[1];})),t.push(a);}));}return t}function evenOrOdd(e){return e%2?"odd":"even"}function rotateArray(e,t){return t?e.unshift(e.pop()):e.push(e.shift()),e}function getTemplate(e){var t=Object.entries(template_cache).filter((function(t){return t[0]===e.templateId}));if(t&&t[0]&&t[0].length>1)return t[0][1]}function getStyle(e){var t=Object.entries(style_cache).filter((function(t){return t[0]===e.styleId}));if(t&&t[0]&&t[0].length>1)return t[0][1]}fetchAndRenderData();
