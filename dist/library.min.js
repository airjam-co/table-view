(function (global, factory) {
  ...
  var SERVING_DATA_URL="http://localhost:3001/s/data?id=",PAGINATION_SHOW_SIZE=7,currentPage={};function fetchAndRenderData(){window&&window.document&&document.querySelectorAll('[display="airjam-tableview"]').forEach((function(e){if(e.getAttribute("id")){var t=e.getAttribute("id");currentPage[t]=1,fetch(SERVING_DATA_URL+t+"&page=1").then((function(a){a.json().then((function(a){var n=getTemplate(a),r=getStyle(a);r.containerClassNames&&Array.isArray(r.containerClassNames)&&(e.className+=" "+r.containerClassNames.join(" "));var o=document.createElement("style");switch(o.appendChild(window.document.createTextNode(r.style)),window.document.head.appendChild(o),ViewType[a.type.valueOf()]){case ViewType.Graph:renderGraphToView(t,e,a,n,r);break;case ViewType.Table:renderTableToView(t,e,a);break;case ViewType.List:case ViewType.Gallery:renderCollectionToView(t,e,a,n);break;case ViewType.Map:renderMapToView(t,e,a,n,r);}}));}));}else e.innerHTML="Please set id attribute to a valid table view id.";}));}function fetchAndRerenderData(e,t,a){void 0===a&&(a=1),window&&window.document&&(currentPage[e]=a,fetch(SERVING_DATA_URL+e+"&page="+a).then((function(a){a.json().then((function(a){var n=getTemplate(a),r=getStyle(a);switch(t.innerHTML="",ViewType[a.type.valueOf()]){case ViewType.Graph:renderGraphToView(e,t,a,n,r);break;case ViewType.Table:renderTableToView(e,t,a);break;case ViewType.List:case ViewType.Gallery:renderCollectionToView(e,t,a,n);break;case ViewType.Map:renderMapToView(e,t,a,n,r);}}));})));}function renderMapToView(e,t,a,n,r){if(n.templateFields&&a.templateFields){var o=window.document.createElement("div");o.className="map-control",t.appendChild(o);new Loader("AIzaSyA8xMW1giwvraqrUpM7bLQeURGjr5VUrBw",{}).load().then((function(i){var l=window.document.createElement("div");l.className="map-container",t.appendChild(l),a.paginationStyle===PaginationStyle.Paged&&renderPagination(e,t,a);var s=new i.maps.Map(l,{zoom:9,zoomControl:!1,panControl:!1,scaleControl:!1,mapTypeControl:!1,streetViewControl:!1,fullscreenControl:!1,styles:r.jsonContent?r.jsonContent:[]}),c=new i.maps.Geocoder,d={},p={},u={};if(a.templateFields.location){var m=a.templateFields.location;a.data.forEach((function(t,r){if(0!==r)if(t[m]){var l=t[m];l.display_as===DataSourceFieldType.Address?setTimeout((function(){c.geocode({address:l.raw_value},(function(l,c){if("OK"===c){s.setCenter(l[0].geometry.location);var m={};Object.keys(n.templateFields).forEach((function(e){a.templateFields[e]&&t[a.templateFields[e]]&&(m[e]=t[a.templateFields[e]].raw_value);}));var f=window.document.createElement("div");f.className="map-control-entry",f.id=e+".map.entry."+r;var w=n.pageContent[PageTypes.LIST];w=w.replaceAll("{{index}}",r),Object.entries(m).forEach((function(e){var t=e[0],a=e[1];w=w.replaceAll("{{"+t+"}}",a);})),f.innerHTML+=w,u[r]=f,populateContainerElementsIfFull(a.data.length-1,o,u);var h=n.pageContent[PageTypes.MARKER];h=h.replaceAll("{{index}}",r),Object.entries(m).forEach((function(e){var t=e[0],a=e[1];h=h.replaceAll("{{"+t+"}}",a);}));var g=new i.maps.InfoWindow({content:h});p[r]=g;var v=new i.maps.Marker({map:s,position:l[0].geometry.location,label:r.toString()});d[r]=v,f.addEventListener("mouseover",(function(e){s.panTo(l[0].geometry.location),closeInfoWindows(p),p[r]&&p[r].open(s,v);})),v.addListener("click",(function(){closeInfoWindows(p),g.open(s,v);var e=f.offsetTop;o.scrollTop=e;})),updateMapBoundToFit(s,d);}else console.log("geocode was unsuccessful:"+c),u[r]="failed";}));}),Math.floor(100*Math.random())):(console.log("will not display this row: "),console.log(t),u[r]="failed");}else u[r]="failed";}));}}));}else console.log(e+" will not be rendered because it does not have required template attributes.");}function populateContainerElementsIfFull(e,t,a){Object.keys(a).length===e&&(t.innerHTML="",Object.keys(a).map((function(e){return parseInt(e)})).sort((function(e,t){return e-t})).forEach((function(e){"string"!=typeof a[e]?t.appendChild(a[e]):(console.log(e+" is not renderable"),console.log(typeof a[e]),console.log(a[e]));})));}function updateMapBoundToFit(e,t){for(var a=new google.maps.LatLngBounds,n=Object.values(t),r=0;r<n.length;r++)n[r].getPosition()&&a.extend(n[r].getPosition());e.fitBounds(a);}function closeInfoWindows(e){Object.values(e).forEach((function(e){e.close();}));}function renderCollectionToView(e,t,a,n,r){if(n.templateFields&&n.pageContent&&a.templateFields){console.log(a);for(var o=function(e){var r=a.data[e];console.log(r);var o={};Object.keys(n.templateFields).forEach((function(e){a.templateFields[e]&&r[a.templateFields[e]]&&(o[e]=r[a.templateFields[e]].raw_value);}));var i=n.pageContent[PageTypes.LIST];Object.entries(o).forEach((function(e){var t=e[0],a=e[1];i=i.replaceAll("{{"+t+"}}",a);})),t.innerHTML+=i;},i=1;i<a.data.length;i++)o(i);a.paginationStyle===PaginationStyle.Paged&&renderPagination(e,t,a);}else console.log(e+" will not be rendered because it does not have required template attributes.");}function renderPagination(e,t,a){var n=window.document.createElement("div");n.className="pagination",t.appendChild(n);var r=currentPage[e]?currentPage[e]:1,o=currentPage[e]?currentPage[e]:1;if(a.totalPages<=PAGINATION_SHOW_SIZE)r=1,o=a.totalPages;else for(var i=PAGINATION_SHOW_SIZE;i>0;)r>1&&(r--,i--),o<=a.totalPages&&(o++,i--);n.appendChild(makePageLink(e,t,1,"<<"));for(var l=1;l<=a.totalPages;l++)n.appendChild(makePageLink(e,t,l,null));n.appendChild(makePageLink(e,t,a.totalPages,">>"));}function makePageLink(e,t,a,n){if(currentPage[e]===a){var r=window.document.createElement("span");return r.innerText=a.toString(),r.className="currentPage",n&&(r.innerText=n),r}var o=window.document.createElement("a");return o.onclick=function(){fetchAndRerenderData(e,t,a);},o.innerText=a.toString(),n&&(o.innerText=n),o.style.cursor="pointer",o}function renderTableToView(e,t,a,n,r){var o="";a.templateProperties&&a.templateProperties.caption&&(o=a.templateProperties.caption);var i=!1;a.templateProperties&&a.templateProperties.striped&&(i="true"===a.templateProperties.striped.toLowerCase());var l=dataToTableMatrix(a);if(l&&l.length){var s=window.document.createElement("table");if(s.className="table table-hover",i&&(s.className+=" table-striped "),t.appendChild(s),o)window.document.createElement("caption").innerHTML=o;var c=window.document.createElement("thead"),d=window.document.createElement("tbody");s.appendChild(c),s.appendChild(d),l.forEach((function(e,t){var a=window.document.createElement("tr");a.className=evenOrOdd(t+1),0===t?c.appendChild(a):d.appendChild(a),e.forEach((function(e,n){var r=0===t?window.document.createElement("th"):window.document.createElement("td");r.appendChild(renderData(e)),r.className=evenOrOdd(n+1),a.appendChild(r);}));}));}}function renderData(e){var t=window.document.createElement("span");if(e.display_as===DataSourceFieldType.Link){var a=window.document.createElement("a");a.href=e.raw_value,a.innerText=e.raw_value,t.appendChild(a);}else t.innerText=e.raw_value;return t}function renderGraphToView(e,t,a,n,r){n.compatibleDisplayType&&Array.isArray(n.compatibleDisplayType)&&n.compatibleDisplayType.filter((function(e){return "graph"===e}))&&renderChartToView(e,t,a,n,r);}function renderChartToView(e,t,a,n,r){var o="bar";n.componentProperties&&n.componentProperties.chartType&&(o=n.componentProperties.chartType);var i=a.templateProperties&&a.templateProperties.useFirstColumnAsLabels&&a.templateProperties.useFirstColumnAsLabels,l=!0;a.templateProperties&&a.templateProperties.showLegends&&"false"===a.templateProperties.showLegends.toLowerCase()&&(l=!1);var s=!1;a.templateProperties&&a.templateProperties.stackedBars&&"true"===a.templateProperties.stackedBars.toLowerCase()&&(s=!0);var c=!1;a.templateProperties&&a.templateProperties.roundedBars&&"true"===a.templateProperties.roundedBars.toLowerCase()&&(c=!0);var d="x";a.templateProperties&&a.templateProperties.showVertically&&"true"===a.templateProperties.showVertically.toString().toLowerCase()&&(d="y");var p=0;r.componentProperties&&r.componentProperties.borderWidth&&(p=Number(r.componentProperties.borderWidth));var u=[];r.colorTheme&&Array.isArray(r.colorTheme)&&(u=r.colorTheme);var m=dataToTableMatrix(a);if(m&&m.length){for(var f=m[0].map((function(e){return e.raw_value})),w=[],h=1;h<m.length;h++){var g=m[h].map((function(e){return e.raw_value}));a.data.forEach((function(){u=rotateArray(u,!0);})),w.push({label:i?g[0]:void 0,data:i?g.slice(1):g,borderWidth:p,borderColor:u.length>0?u.slice():void 0,backgroundColor:u.length>0?u.slice():void 0,borderRadius:c?500:0});}console.log(w);var v=window.document.createElement("canvas");v.id=e,t.appendChild(v);new Chart(v,{type:o,data:{labels:i?f.slice(1):f,datasets:w},options:{indexAxis:d,scales:{x:{stacked:s},y:{stacked:s}},plugins:{legend:{display:l}}}});}}function dataToTableMatrix(e){var t=[];if(e.data&&e.data.length){var a=Object.keys(e.data[0]),n={};a.forEach((function(e,t){n[e]=t;})),e.data.forEach((function(e){var a=[];Object.entries(e).forEach((function(e){a[n[e[0]]]=e[1];})),t.push(a);}));}return t}function evenOrOdd(e){return e%2?"odd":"even"}function rotateArray(e,t){return 0===e.length||(t?e.unshift(e.pop()):e.push(e.shift())),e}function getTemplate(e){var t=Object.entries(template_cache).filter((function(t){return t[0]===e.templateId}));if(t&&t[0]&&t[0].length>1)return t[0][1]}function getStyle(e){var t=Object.entries(style_cache).filter((function(t){return t[0]===e.styleId}));if(t&&t[0]&&t[0].length>1)return t[0][1]}fetchAndRenderData();
